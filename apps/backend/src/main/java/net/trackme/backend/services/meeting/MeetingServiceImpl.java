...
public class MeetingServiceImpl implements MeetingService {
    ...
    @Override
    @Transactional
    @PreAuthorize("hasPermission(#meetingId, 'net.trackme.backend.domain.Meeting', 'WRITE') or hasRole('ADMIN')")
    ...
    @Override
    @PreAuthorize("hasPermission(#meetingId, 'net.trackme.backend.domain.Meeting', 'READ') or hasRole('ADMIN')")
