...
import net.akarmanov.projectplace.sso.services.impl.RedisOAuth2AuthorizationConsentService;
import net.akarmanov.projectplace.sso.services.impl.RedisOAuth2AuthorizationService;
