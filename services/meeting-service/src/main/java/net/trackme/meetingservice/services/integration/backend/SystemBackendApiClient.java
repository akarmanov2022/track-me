...
@Service("systemBackendApiClient")
public class SystemBackendApiClient extends BaseBackendApiClient implements BackendApiClient {
    public SystemBackendApiClient(
            @Qualifier("serviceRestClient") RestClient client,
